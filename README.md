...
```sh
# curl
curl -L https://github.com/nazebzurati/env-sync/releases/latest/download/env-sync-x86_64-linux -o ~/.local/bin/env-sync && chmod +x ~/.local/bin/env-sync

# wget
wget -O ~/.local/bin/env-sync https://github.com/nazebzurati/env-sync/releases/latest/download/env-sync-x86_64-linux && chmod +x ~/.local/bin/env-sync
```
